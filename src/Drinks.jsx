...
function Drinks() {
  const drinkItems = useSelector((state) => state.products.drinksProducts || []);
  ...
  const drinksListItems = currentItems.map((product) => (
  ...
  return (
    ...
    <ToastContainer position = "top-right" autoClose = {2000} />
      ...
      <ul className="item drinks-grid">{drinksListItems}</ul>
